...
SetupWindowTitle=Instalacja aplikacji ePodrêczniki
...
; *** Common wizard text
ClickNext=Kliknij przycisk Dalej, aby kontynuowaæ instalacjê, lub Anuluj, aby zakoñczyæ dzia³anie kreatora instalacji.
BeveledLabel=
...
; *** "Welcome" wizard page
WelcomeLabel1=Witamy w kreatorze instalacji aplikacji [name]
WelcomeLabel2=Ten kreator zainstaluje aplikacjê [name/ver] na Twoim komputerze. Przed kontynuacj¹ instalacji zalecane jest zakoñczenie dzia³ania innych aplikacji.
...
LicenseLabel=Przed instalacj¹ aplikacji Rozpoznawanie Mowy zapoznaj siê uwa¿nie z niniejsz¹ Umow¹ Licencyjn¹.
LicenseLabel3=Aby zainstalowaæ aplikacjê, nale¿y zaakceptowaæ warunki i postanowienia Umowy Licencyjnej.
LicenseAccepted=&Akceptujê wszystkie warunki Umowy Licencyjnej
LicenseNotAccepted=&Nie akceptujê wszystkich warunków Umowy Licencyjnej
...
ClickFinish=Kliknij przycisk Zakoñcz, aby zakoñczyæ dzia³anie kreatora instalacji aplikacji Rozpoznawanie Mowy.
...
ShutdownBlockReasonInstallingApp=Instalacja %1.
